...
module AWS::CloudWatch
  ...
  class Client
    ...
    include AWS::CloudWatch::Functions
    ...
    def initialize(access_key, secret_key, region = nil, endpoint = nil)
      ...
      @endpoint = HTTP::Parser.new.parse_url(
          "https://#{AWS::CloudWatch::SERVICE}.#{@region}.amazonaws.com")
    ...
    def request(method = 'GET', params = {}, header = {})
      ...
      sign_key = Digest::HMAC.digest('aws4_request',
        Digest::HMAC.digest(AWS::CloudWatch::SERVICE,
